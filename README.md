...
Note: Github recommends using SSH when working with repositories, to connect to Github using SSH, follow the instructions from [here](https://docs.github.com/en/authentication/connecting-to-github-with-ssh).

To clone the repository using SSH, use the following command:

```
git clone git@github.com:Darkkii/isd-project-2024.git
```

To clone the repository using HTTPS, use the following command:

```
git clone https://github.com/Darkkii/isd-project-2024.git
```
...
## IDE Configuration - CLion - Mac/Linux

To be added if necessary.

## IDE Configuration - VSCode - Windows

To be added if necessary.

## IDE Configuration - VSCode - Mac/Linux
