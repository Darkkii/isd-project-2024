...
I2CTask::I2CTask(std::shared_ptr<I2c::PicoI2C> i2cDevice, std::shared_ptr<Uart::PicoOsUart> uartDevice, std::shared_ptr<Sensor::SensorData> sensorData) : BaseTask{"I2CTask", 1024, this, MED} {
